...
export default function PostStack() {
  return (
    <Stack.Navigator
      ...
      screenOptions={{ }}
    >
      <Stack.Screen name="Posted" component={PostedScreen} options={{title: "Bài đã đăng"}} />
      <Stack.Screen name="ViewPost" component={ViewPostScreen} />
      <Stack.Screen name="EditPost" component={EditPostScreen} />
      <Stack.Screen name="UserApply" component={UserApply} options={{title: "Thành Viên Nộp Đơn"}} />
      <Stack.Screen name="InfoSister" component={InfoSisterScreen} options={{title: "Thông tin về Sister"}} />
    </Stack.Navigator>
  );
}
